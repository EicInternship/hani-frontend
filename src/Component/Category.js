    ...
    <div>
        <form onSubmit={(e)=>handleSubmit(e)}>
             ...
             maxWidth={400}
              alignItems="center"
               ...
               sx={{
                  ...
                  <Typography variant="h5" padding={1} textalign="center"> Add Category</Typography>
            <TextField type={"text"} 
            ...
            value={Categorydata.categotydescription} 
             ...
             margin="normal"/>
            {errors.categoryDescription && <span style={{ color: "red" }}>{errors.categoryDescription}</span>}
            <Button type={"submit"}
             variant='contained'
             sx={{ marginTop: 3, borderRadius: 3 }}>Add Category</Button>
            </Box>
        </form>
    </div>
  )
